      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-2">
            {navItems.map((item) => (
              <GooeyNav key={item.path} isActive={isActive(item.path)}>
                <Link
                  to={item.path}
            ...
            <div className="flex items-center space-x-2 ml-4">
              <GooeyNav>
                <a href="#" className="p-2 text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors rounded-lg">
                  <Github size={20} />
                </a>
              </GooeyNav>
              <GooeyNav>
